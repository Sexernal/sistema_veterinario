...
function PetModal({ onClose, onSaved, owners = [], initial = null }) {
  ...
  return (
    <ModalBase
      ...
      subtitle="Asocia la mascota a un propietario"
      onClose={onClose}
      maxWidth={600}
    >
      <form onSubmit={submit}>
            ...
            <div key={f.id} style={{
              ...
              <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", gap:8 }}>
                <div style={{ flex:1 }}>
                  ...
                  {f.nota && (
                    <div style={{ marginTop:8, fontSize:13, lineHeight:1.5 }}>{f.nota}</div>
                  )}
                  {f.filepath && (
...
export default function PropietariosPage() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"var(--bg)" }}>
              ...
              return (
                ...
                >
                  ...
                  <div style={{
                    ...
                    <div style={{ fontSize:13, fontWeight:800, color: active ? "var(--accent)" : "var(--text)" }}>
                      {petsByOwner[o.id] || 0}
                    </div>
            ...
            <>
              ...
              {selectedPets.length === 0 ? (
                <div style={{ padding:"36px 24px", borderRadius:12, textAlign:"center", border:"1px dashed rgba(255,255,255,0.1)", color:"var(--subtext)" }}>
                  ...
                  <button className="btn" style={{ marginTop:14 }} onClick={() => setPetModal("new")}>
                    ...
                    <div key={p.id} className="card" style={{ display:"flex", justifyContent:"space-between", alignItems:"center", gap:12 }}>
                      <div style={{ display:"flex", gap:12, alignItems:"center", minWidth:0 }}>
                        <div style={{
                          ...
                          {getSpeciesIcon(p.especie)}
                        </div>
                        <div style={{ minWidth:0 }}>
                          <div style={{ fontWeight:700, fontSize:15 }}>
                            {p.nombre}
                            {p.especie && (
                              <span style={{ marginLeft:6, fontSize:12, color:"var(--subtext)", fontWeight:400 }}>
                                ({p.especie})
                              </span>
                            )}
                          </div>
      ...
      {ownerModal !== null && (
        <OwnerModal
          initial={ownerModal === "new" ? null : ownerModal}
      ...
      {petModal !== null && (
        <PetModal
          initial={petModal === "new" ? null : petModal}
          owners={owners}
      ...
      {fichasTarget !== null && (
        <FichasModal pet={fichasTarget} onClose={() => setFichasTarget(null)} />
      )}
    </div>
  );
}